...
export class NgxPwdService {
  rules = [
    { key: 'length', message: 'Minimum of 8 characters' },
    { key: 'digits', message: 'Must have at least 1 numeric value' },
    { key: 'lower', message: 'Must have at least 1 lowercase alphabet' },
    { key: 'upper', message: 'Must have at least 1 uppercase alphabet' },
    { key: 'nonWords', message: 'Must have at least 1 special character' }
  ]
